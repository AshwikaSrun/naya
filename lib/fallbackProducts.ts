...
export const FALLBACK_TRENDING: FallbackItem[] = [
  { title: 'Vintage Carhartt Jacket', query: 'vintage carhartt jacket', price: '$35–80', image: STOCK.jacket },
  { title: 'Baggy Levi 550', query: 'baggy levi 550', price: '$25–50', image: STOCK.denim },
  { title: 'Vintage Nike Crewneck', query: 'vintage nike crewneck', price: '$20–45', image: STOCK.crewneck },
  { title: 'Y2K Zip Hoodie', query: 'y2k zip hoodie', price: '$25–55', image: STOCK.hoodie },
  { title: 'Vintage Band Tee', query: 'vintage band tee', price: '$15–40', image: STOCK.tee },
...
export function getFallbackForCampus(campusName: string): FallbackItem[] {
  const campus = [
    { title: `Vintage ${campusName} Hoodie`, query: `vintage ${campusName.toLowerCase()} hoodie`, price: '$25–55', image: STOCK.hoodie },
    { title: `Vintage ${campusName} Crewneck`, query: `vintage ${campusName.toLowerCase()} crewneck`, price: '$20–50', image: STOCK.crewneck },
    { title: `${campusName} Merch`, query: `vintage ${campusName.toLowerCase()}`, price: '$20–60', image: STOCK.jacket },
  ];
  const base = [
    { title: 'Vintage Carhartt Jacket', query: 'vintage carhartt jacket', price: '$35–80', image: STOCK.jacket },
    { title: 'Nike Vintage Crewneck', query: 'vintage nike crewneck', price: '$20–45', image: STOCK.crewneck },
    { title: 'Baggy Levi 550', query: 'baggy levi 550', price: '$25–50', image: STOCK.denim },
    { title: 'Y2K Zip Hoodie', query: 'y2k zip hoodie', price: '$25–55', image: STOCK.hoodie },
    { title: 'Vintage Band Tee', query: 'vintage band tee', price: '$15–40', image: STOCK.tee },
    { title: 'Vintage Ralph Lauren', query: 'vintage ralph lauren', price: '$30–90', image: STOCK.vintage },
    { title: 'Vintage Denim Jacket', query: 'vintage denim jacket', price: '$40–85', image: STOCK.jacket },
    { title: 'Vintage Streetwear', query: 'vintage streetwear', price: '$30–70', image: STOCK.streetwear },
  ];
